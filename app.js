...
const API_PROD = process.env.API_TEST;
const app = express();
...
const appendSocketToLicense = (pi_data) => {
    axios.post(`${API_TEST}/license/UpdateSocketIds`, pi_data)
    .then((res) => {    
...
const getLicenseSocketID = license_id => {
    return axios.get(`${API_TEST}/license/GetSocketByLicense?licenseId=${license_id}`)
    .then((res) => {
        return res.data;
    }).catch((error) => {
...
const getSocketLicenseId = socket_id => {
    return axios.get(`${API_TEST}/License/GetByPiSocketId?socketid=${socket_id}`)
...
const offlineNotification = (data) => {
    axios.post(`${API_TEST}/notification/send`, data)
    .then(function (response) {
...
const updateLicensePiandPlayerStatus = (data) => {
    axios.post(`${API_TEST}/license/UpdatePiPlayerStatus`, data)
    .then(res => {
